...
# @see https://github.com/jeremyevans/sequel/blob/4.49.0/lib/sequel/extensions/string_agg.rb
# The reasons for this patch are 4.49 is not updated anymore and Redshift is not officially
# supported by sequel.
#
